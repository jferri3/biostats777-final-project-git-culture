...
Our goal is to provide users the opportunity to explore interesting associations between the distribution of these phenomena and to delve into their geographic and temporal distributions across Califronia's 58 counties.

## How to Use This Dashboard  {.card}
...
:::: grid
::: g-col-6
## Day vs Night Sightings  {.card}

**When do UFOs Appear?** Explore h time of day influences the likelihood of spotting a UFO.
